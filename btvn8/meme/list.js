...
class List extends BaseComponent {
            ...
            memes: [
                (async () => {
                    ...
                    for (let item of result.docs) {
                        this.state.memes.push(item.data())
                    }
                })()  
            ]
        }
    ...
    render() {
        ...
        // add vao table, add len firebase


        async function addMeme(obj) {
            await run.add({
                name: obj.name,
                image: obj.image,
                description: obj.description,
                "date-modified": obj["date-modified"],
                "is-editing": obj["is-editing"],
            })
        }
